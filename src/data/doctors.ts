...
export const DOCTORS_DATA: Doctor[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/kW1dQSi.jpg',
    bio: { 
      tr: 'Deneyimli hekimimiz Umut Kocaoglan, güncel tedavi yaklaşımlarıyla hastalarımızın gülüşlerini ve genel ağız sağlıklarını en üst seviyeye çıkarmayı hedeflemektedir.',
      en: 'Our experienced dentist, Umut Kocaoglan, aims to maximize our patients\' smiles and overall oral health with current treatment approaches.',
      de: 'Unser erfahrener Zahnarzt, Umut Kocaoglan, zielt darauf ab, das Lächeln und die allgemeine Mundgesundheit unserer Patienten mit aktuellen Behandlungsansätzen zu maximieren.'
    }
  }
];