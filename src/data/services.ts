  ...
  },
  {
    ...
    longDescription: {
      ...
      de: `
        ...
        <ul class="list-disc list-inside space-y-2 mb-4">
          <li><strong>Intraorale Scanner (3D-Scanner):</strong> Diese Geräte, die den durch traditionelle Abformmethoden verursachten Würgereflex eliminieren, erstellen in Sekzenschnelle ein dreidimensionales digitales Modell Ihrer Zähne. Dies ermöglicht präzise und schnelle Abformungen.</li>
