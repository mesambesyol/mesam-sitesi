...
import { UserCircleIcon, AcademicCapIcon, ClipboardDocumentListIcon, BriefcaseIcon, SparklesIcon } from '../constants/icons.tsx';
import { useLanguage } from '../contexts/LanguageContext.tsx';
import { DoctorDetailSection } from '../types.ts';
      ...
      <div className="bg-stone-100 py-12 sm:py-16">
        <PageContainer>
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              <Link to="/hekimlerimiz" className="text-sm text-brand-teal hover:text-brand-blue transition-colors">
